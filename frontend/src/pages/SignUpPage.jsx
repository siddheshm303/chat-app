        ...
        <div className='w-full max-w-md space-y-8'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            <div className='form-control'>
              ...
              <div className='relative'>
                <div className='absolute inset-y-0 left-0 pl-3 z-10 flex items-center pointer-events-none'>
                  <User className='size-5 text-base-content/40 opacity-50' />
                </div>
                <input
                  type='text'
            ...
            <div className='form-control'>
              ...
              <div className='relative'>
                <div className='absolute inset-y-0 left-0 pl-3 z-10 flex items-center pointer-events-none'>
                  <Mail className='size-5 text-base-content/40 opacity-50' />
                </div>
                <input
                  type='email'
                  className={`input input-bordered w-full pl-10`}
            ...
            <div className='form-control'>
              ...
              <div className='relative'>
                <div className='absolute inset-y-0 left-0 pl-3 z-10 flex items-center pointer-events-none'>
                  <Lock className='size-5 text-base-content/40 opacity-50' />
                </div>
                <input
